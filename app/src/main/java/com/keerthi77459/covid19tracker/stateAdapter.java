...
public class stateAdapter extends RecyclerView.Adapter<stateAdapter.MyViewHolder> {
    ...
    public stateAdapter(Context context, ArrayList<stateName> list) {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            stateName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    editor.putString("StateName",stateName.getText().toString());
                    editor.commit();
                    Intent intent = new Intent(itemView.getContext(),DistrictActivity.class);
